...

{
  ...
  {
    image: "bbc8.jpg",
    name: "The Secret - RHONDA BYRNE  (English, Hardcover, Byrne Rhonda)",
    price: "₹799",
  },
  {
    image: "bbc9.jpg",
  ...
  {
    image: "bbc12.jpg",
    name: "Diary of a Wimpy Kid: Wrecking Ball (Book 14)  (English, Hardcover, Kinney Jeff)",
    price: "₹499",
  },
  {
    image: "bbc13.jpg",
  ...
  {
    image: "palettes.jpg",
    name: "KABEER ART 16 Well Rectangle Plastic Painting Palette",
    price: "₹190",
  },
  {
...
export default function bbc() {
  ...
  <div className="container text-center py-3">
      <h2 className="pb-2 border-bottom text-center">Bansathali Book Centre</h2>
